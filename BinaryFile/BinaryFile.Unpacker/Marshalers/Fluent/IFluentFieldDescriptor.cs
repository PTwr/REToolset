...
namespace BinaryFile.Unpacker.Marshalers.Fluent
{
        ...
        where TImplementation : IFluentFieldDescriptor<TDeclaringType, TItem, TImplementation>
    {
        ...
        public delegate void PostProcessCollectionItemDelegate(TDeclaringType declaringObject, TItem item, int n, int itemByteLength, int itemOffset);
        ...
        TImplementation AfterSerializing(PostProcessCollectionItemDelegate postProcessItemByteLength);
    }
